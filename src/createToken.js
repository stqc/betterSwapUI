    ...
    <div className="create-content">
        ...
        <select name="token" id='token-type' ref={selectedValue} style={{color:"white", background:"transparent", border:"1px solid white", borderRadius:"15px",padding:"1%", width:"100%",marginTop:"1%"}}>
            ...
            <div className="form-content">
                ...
                <input style={{color:"white", background:"transparent", border:"1px solid white", borderRadius:"15px", padding:"1%", width:"100%",marginTop:"1%"}} placeholder="Enter Liqudity Tax portion of the total tax (type 0 incase of Simple BetterSwap Token)" ref={lpt}></input>
            </div>
